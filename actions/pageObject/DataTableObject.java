...
public class DataTableObject extends AbstractPage {
	...
	public void sendkeysToTextbox(String columnName, String rowNumber, String value) {
		waitForElementVisible(driver, dataTableUI.COLUMN_INDEX, columnName);
		int columnPosition = countElementNumber(driver, dataTableUI.COLUMN_INDEX, columnName) + 1;
		System.out.println("number row = " + columnPosition);
		sendkeyToElement(driver, dataTableUI.CELL_ROW_COLUMN, value, rowNumber, String.valueOf(columnPosition) );
